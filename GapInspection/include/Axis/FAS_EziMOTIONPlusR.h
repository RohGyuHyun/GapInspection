...
FAPI int WINAPI	FAS_SetIOInputEx(BYTE nPortNo, BYTE iSlaveNo, DWORD dwIOSETMaskLow, DWORD dwIOSETMaskHigh, DWORD dwIOCLRMaskLow, DWORD dwIOCLRMaskHigh);
FAPI int WINAPI	FAS_GetIOInput(BYTE nPortNo, BYTE iSlaveNo, ULONGLONG* uIOInput);
FAPI int WINAPI	FAS_GetIOInputEx(BYTE nPortNo, BYTE iSlaveNo, DWORD* dwIOInputLow, DWORD* dwIOInputHigh);
...
FAPI int WINAPI	FAS_BrakeSet(BYTE nPortNo, BYTE iSlaveNo, BOOL bSet, int* nResult);
...
FAPI int WINAPI	FAS_GetIOStatusEx(BYTE nPortNo, BYTE iSlaveNo, DWORD* dwInStatusLow, DWORD* dwInStatusHigh, DWORD* dwOutStatus);
...
FAPI int WINAPI	FAS_GetAllStatusEx(BYTE nPortNo, BYTE iSlaveNo, DWORD* dwInStatusLow, DWORD* dwInStatusHigh, DWORD* dwOutStatus, DWORD* dwAxisStatus, long* lCmdPos, long* lActPos, long* lPosErr, long* lActVel, WORD* wPosItemNo);
